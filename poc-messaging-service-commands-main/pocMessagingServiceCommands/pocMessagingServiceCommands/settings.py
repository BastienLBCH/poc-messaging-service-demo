"""
Django settings for pocMessagingServiceCommands project.
...
WSGI_APPLICATION = 'pocMessagingServiceCommands.wsgi.application'
...
KAFKA_BOOTSTRAP_SERVER = env("BOOTSTRAP_SERVER")
TOPIC = env("TOPIC")
